...
final class MockedData {
    ...
    static let customDomainUpdate = jsonData(forJsonName: "CustomDomainUpdate")
    ...
    static let usableDomain = jsonData(forJsonName: "UsableDomain")
    ...
    static let token = jsonData(forJsonName: "Token")
}
